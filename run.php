...
$APIKey = 'lih9FS8eA5fQF0lQrvCYWAVQ';//百度AI开放平台数字识别API Key，建议自己申请，用我的也行
$SecretKey = 'UO2VQQbRnckRgrqNUGIpOsGgwnQVWBcS';//百度AI开放平台数字识别API Key，建议自己申请，用我的也行

$file = fopen("phone_num.txt", "r");
$cjhaoma=array();
$i=0;
while(! feof($file))
{
